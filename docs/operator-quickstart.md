# Operator Quickstart — Community Motorcycle Sale & Repair Operations

Shortest path from clone to a verified local dry-run for **ISIC 4540** (`cloud-itonami-isic-4540`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4540.git
cd cloud-itonami-isic-4540
```
...
- Blueprint governor key: `motorcycle-ops-governor`
- Likely source path: `motorcycleops.governor.cljc`
